<template>
  <v-app>
    <v-main>
      <v-overlay v-model="$nuxt.isOffline">
        <div align="center">
    ...
    <v-footer>
      ...
      <v-row justify="center" no-gutters>
        <nuxt-link to="/Terms" class="link mr-5">Terms of Use</nuxt-link>
        <nuxt-link to="/PrivacyPolicy" class="link mr-5">Privacy Policy</nuxt-link>
      </v-row>
      <v-row justify="center" no-gutters>
