...
export default {
  ...
  css: ["~/static/css/main.css", "~/static/css/vuetify.css"],
  ...
  modules: ["@nuxtjs/axios", "@nuxtjs/auth-next", "@nuxtjs/proxy", "cookie-universal-nuxt", "@nuxtjs/recaptcha", "@nuxtjs/i18n", "@nuxtjs/dayjs"],
